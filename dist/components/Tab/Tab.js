...
var TabGroup = exports.TabGroup = function TabGroup(_ref) {
  var _ref$defaultActive = _ref.defaultActive,
    defaultActive = _ref$defaultActive === void 0 ? "" : _ref$defaultActive,
    children = _ref.children;
  var _React$useState = _react["default"].useState(defaultActive),
...
var Tab = function Tab(_ref2) {
  ...
  var context = (0, _react.useContext)(TabContext);
  if (!context) {
  ...
  var activeClass = isActive ? _tabModule["default"]['active'] : ''; // classe pour l'état actif

  return /*#__PURE__*/_react["default"].createElement("div", _extends({
    className: "".concat(_tabModule["default"]['tab__block'], " ").concat(_tabModule["default"]['tab__block--default'], " ").concat(className, " ").concat(activeClass),
